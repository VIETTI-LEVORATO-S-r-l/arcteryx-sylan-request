...
const it = {
  ...
  "form.s5h": "A fine esperienza è previsto un lunch box.",
  "form.dietary": "Profilo alimentare",
  "form.allergies": "Allergie o intolleranze alimentari",
  "form.allergiesHint": "Solo quanto serve per il lunch box.",
...
const en: Record<keyof typeof it, string> = {
  ...
  "form.s5h": "A lunch box is provided at the end of the experience.",
  "form.dietary": "Dietary profile",
  "form.allergies": "Food allergies or intolerances",
  "form.allergiesHint": "Only what is needed for the lunch box.",
